                    ...
                    >
                        ...
                        <SwiperSlide className='Help1-SwiperSlide'>
                            ...
                            <div className='mb-5 grow text-end w-1/2 Help2Last pretendard-R text-2xl mt-3 flex flex-col justify-end'>
                                <p className='break-keep'>
                                    <BiSolidQuoteLeft className='quoteicon inline-block mb-5' size={12} />
                                    헤이찰스는 수익의 일부를 유기견 후원에 기부합니다. 착한 소비로 좋은 제품을 만드는 것이 헤이찰스의 운영 정신입니다. 앞으로도 유기견 아이들을 돕고 관심을 가지도록 하겠습니다.  <BiSolidQuoteRight className='quoteicon inline-block mb-5' size={12} />
                                </p>
                        ...
                        <SwiperSlide className='Help1-SwiperSlide'>
                            ...
                            <div className='mb-5 grow text-end w-1/2 Help2Last pretendard-R text-2xl mt-3 flex flex-col justify-end'>
                                <p className='break-keep'>
                                    <BiSolidQuoteLeft className='quoteicon inline-block mb-5' size={12} />
                                    성결대학교 창업동아리 PIU
                                    저희 각자의 소프트웨어 개발 전공을 살려 사회의 작지만 선한 영향을 미치고 싶습니다. 버려진 아이들이 반드시 좋은 새가족을 찾을 수 있도록 함께하겠습니다<BiSolidQuoteRight className='quoteicon inline-block mb-5' size={12} />
                                </p>
