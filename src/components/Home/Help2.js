                    ...
                    >
                        ...
                        <SwiperSlide className='Help1-SwiperSlide'>
                            ...
                            <div className='mb-5 grow text-end w-1/2 Help2Last pretendard-R text-2xl mt-3 flex flex-col justify-end'>
                                ...
                                <p className='text-lg mt-3 help2name'>-유기견 후원 반려견 의류 기업 HEY, CHALES 안수림 대표-</p>
                            </div>
                        </SwiperSlide>
                        <SwiperSlide className='Help1-SwiperSlide'>
                            ...
                            <div className='mb-5 grow text-end w-1/2 Help2Last pretendard-R text-2xl mt-3 flex flex-col justify-end'>
                                ...
                                <p className='text-lg mt-3 help2name'>메타버스 패션, 쇼핑 플랫폼 Pet In Universe 대표 편진범 외 14명</p>
                            </div>
                        </SwiperSlide>
                    </Swiper>
