...
import PiuCampaignHori from "../PiuCampaignHori";
                ...
                >
                    <SwiperSlide className="Help2-SwiperSlide">
                        <div className="w-full flex items-center justify-center text-center">
                            ...
                            <div className="w-6/12 break-keep">유기견들의 현실은 <br />우리가 생각하는 것보다 더 <span className="PointBlack">심각</span>합니다.</div>
                    ...
                    <SwiperSlide className="Help2-SwiperSlide">
                        <div className="w-full flex items-center justify-center text-center">
                            ...
                            <div className="w-6/12 break-keep">
                    ...
                    <SwiperSlide className="Help2-SwiperSlide">
                        <div className="w-full flex items-center justify-center text-center">
                            <img className='w-3/12' src={images.back2} />
                            <div className="w-6/12 break-keep">
                                희망과 사랑을 주어 유기견들의 <span className="PointBlack">새로운 시작</span>을 도와주세요.
                            </div>
