                        ...
                        <SwiperSlide className="Help2-SwiperSlide">
                            <div className="w-full flex items-center justify-center text-center">
                                ...
                                <div className="w-8/12 break-keep px-5 text-5xl leading-snug">
                                    ...
                                    <p className="pretendard-R text-sm mt-2 absolute -right-20 bottom-2">https://chasingrainbowsforever.tumblr.com/post/695818284859326464/black-and-gray</p>
                                </div>
                        ...
                        <SwiperSlide className="Help2-SwiperSlide">
                            <div className="w-full flex items-center justify-center text-center">
                                ...
                                <div className="w-6/12 break-keep px-5 text-5xl leading-snug">
                                    ...
                                    <p className="pretendard-R text-sm mt-2 absolute -right-20 bottom-2">대전 유성구 송정동 유기동물 사설보호소 ‘시온쉼터’ 견사의 모습. 약 1평(3.3제곱미터) 남짓한 견사 1곳당 10~20마리의 유기견들이 생활하고 있다.</p>
                                </div>
                        ...
                        <SwiperSlide className="Help2-SwiperSlide">
                            <div className="w-full flex items-center justify-center text-center">
                                ...
                                <div className="w-6/12 break-keep px-5 text-5xl leading-snug">
                                    ...
                                    <p className="pretendard-R text-sm mt-2 absolute -right-20 bottom-2">정읍시 보호소 유기견들. 동물자유연대 공식 블로그</p>
