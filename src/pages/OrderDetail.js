            ...
            <div className="Order">
                <div className="container mx-auto">
                    <div className="text-center">
                        ...
                        <div>주문번호 : 0000000000000000</div>
                        <div>결제날짜 : 2023.00.00</div>
                    </div>
                    ...
                    <div className="w-2/3 mx-auto border m-10 p-5">
                        ...
                        <div className="px-10 py-5">
                            ...
                            <div className="p-3 w-1/2">
                                <p className="w-full flex mb-2">
                                    ...
                                    <p className="w-8/12">홍길동</p>
                                </p>
                                <p className="w-full flex mb-2">
                                    <p className="w-4/12 text-neutral-400">연락처</p>
                                    <p className="w-8/12">010-0000-0000</p>
                                </p>
                                <p className="w-full flex">
                                    <p className="w-4/12 text-neutral-400">이메일</p>
                                    <p className="w-8/12">tmdgml1231@nave.rcom</p>
                                </p>
                            </div>
                        </div>
                        <div className="px-10 py-5">
                        ...
                        <div className="px-10 py-5">
                            ...
                            <div className="p-3 w-1/2">
                                ...
                                <p className="w-full flex">
                                    <p className="w-4/12 text-neutral-400">연락처</p>
                                    <p className="w-8/12">우리은행 000000000000</p>
                                </p>
                            </div>
                        </div>
                    </div>
